 ...
 *
 * Manages grove-scoped environment variables and secrets using the shared
 * <scion-env-var-list> and <scion-secret-list> components in compact mode.
 * Retains grove loading, back link, and page header.
 */
